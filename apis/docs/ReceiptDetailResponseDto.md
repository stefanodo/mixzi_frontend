...
`createdAt` | Date
`validatedAt` | object
`lines` | [Array&lt;ReceiptLineResponseDto&gt;](ReceiptLineResponseDto.md)
`latestExtractionRun` | [ReceiptExtractionRunResponseDto](ReceiptExtractionRunResponseDto.md)

## Example

```typescript
import type { ReceiptDetailResponseDto } from ''
...
} satisfies ReceiptDetailResponseDto
...
const exampleParsed = JSON.parse(exampleJSON) as ReceiptDetailResponseDto
